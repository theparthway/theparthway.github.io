const virgin = [
  ...
  "Been sent to the office of a principal",
  "Been put on disciplinary probation or suspended?",
  "Urinated in public?",
  "Gone skinny-dipping?",
  "Gone streaking? (running naked in public)",
  "Seen a stripper?",
  ...
  "Committed an act of voyeurism? (recording someone having sex)",
...
const nonvirgin = [
  ...
  "Been convicted of a felony?",
  "Committed an act of vandalism?",
  "Committed an act of voyeurism? (recording or watching someone having sex)",
  "Committed an act of incest?",
  "Engaged in bestiality? ",
